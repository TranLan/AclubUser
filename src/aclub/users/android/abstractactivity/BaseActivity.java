...
import aclub.users.android.login.ui.activities.VerifyEmailTokenActivity;
...
public class BaseActivity extends Activity implements OnClickListener {
		...
		LoginManager.getInstance().registerCallback(callbackManager,
				new FacebookCallback<LoginResult>() {
					...
					public void onSuccess(LoginResult loginResult) {
						handlePendingAction();
						updateUI();
						Toast.makeText(BaseActivity.this, getString(R.string.login_facebook_success),
	...
	private void updateUI() {
		...
		CommonValues.currentFbProflie = profile;
	...
	public void displayErrorDialog(ErrorMessage error, Activity activity) {
		ErrorRegister errorRegister = JsonHelper.fromJson(error.getErrorBody(),
				ErrorRegister.class);

		if (errorRegister != null) {
			final CusDialogNotify dialog = new CusDialogNotify(activity,
					errorRegister.getErrors(), getString(R.string.error_title));
	...
	public void displayDialogNotify(String content, Activity activity) {
		final CusDialogNotify dialog = new CusDialogNotify(activity, content,
				"");
		dialog.setEvendialog(new EventDialog() {
