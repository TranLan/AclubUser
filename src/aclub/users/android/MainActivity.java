...
public class MainActivity extends BaseActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		spf = SpManager.getInstances(MainActivity.this);
		if (spf.getBoolean(SPConstants.LOGINED, false)) {
			DLog.d("LOGINED");
			gotoAclubMainActivity();
		} else {
	...
	private void gotoAclubMainActivity() {
		Intent intent = new Intent(MainActivity.this, AclubMainActivity.class);
	...
	private void initUI() {
		...
		hotSaleTv.setText(getString(R.string.main_title_sale_every_day)
				.toUpperCase());
	...
	private void printKeyHash() {
		try {
			PackageInfo info = getPackageManager().getPackageInfo(
					"aclub.users.android", PackageManager.GET_SIGNATURES);
